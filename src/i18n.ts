...
export const strings = {
  zh: {
    ...
    run: "运行",
    resetCode: "重置代码",
    loadingUi5: "正在加载 UI5 运行时…",
    ui5LoadError: "加载 UI5 失败：需要联网访问 CDN。",
    runtimeError: "运行出错",
    output: "输出",
    correct: "✅ 正确！",
    wrong: "❌ 再想想",
  ...
  en: {
    ...
    loadingUi5: "Loading UI5 runtime…",
    ui5LoadError: "Failed to load UI5 — needs internet access to the CDN.",
